...
namespace Rendeles_Forms_EM9NYU.Data;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=barnimedve.database.windows.net;Initial Catalog=Student;Persist Security Info=True;User ID=barnimedve;Password=Corvo12345678; Trust Server Certificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Cim>(entity =>
        {
            entity.HasKey(e => e.CimId).HasName("PK__CIM__8A3BFC16A39A7174");
        });

        modelBuilder.Entity<Rendeles>(entity =>
        {
            entity.HasKey(e => e.RendelesId).HasName("PK__RENDELES__8DBDC2AD16F5C936");
        ...
        {
            entity.HasKey(e => e.TetelId).HasName("PK__RENDELES__18F19F749B6EF1A1");
        ...
        {
            entity.HasKey(e => e.TermekId).HasName("PK__TERMEK__05635B29B7790B49");
        ...
        {
            entity.HasKey(e => e.KategoriaId).HasName("PK__TERMEK_K__37D210EC682C2EE7");
        ...
        {
            entity.HasKey(e => e.UgyfelId).HasName("PK__UGYFEL__BD19A371EF60D0B5");
